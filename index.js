    ...
    if (['report'].includes(command) && message.channel.guild.id === "409966133547106305") {
        ...
        if (message.channel.guild.region == "russia") {
            message.channel.guild.region = "Россия"
                ...
                .addBlankField('>Owner<', message.channel.guild.owner, inline)
                .addField('Owner ID', message.channel.guild.ownerID)
                .addBlankField('>Уровень верификации<', message.channel.guild.verificationLevel, inline)
                .addField('>Количество пользователей<', message.channel.guild.memberCount)
                .addBlankField('>Количество ролей<', message.channel.guild.roles.size, inline)
                .addField('>Количество каналов<', message.channel.guild.channels.size)
                .addBlankField('>Сервер большой?<', large, inline)
                .addField('>Системный канал<', message.channel.guild.systemChannel !== null ? message.channel.guild.systemChannel : 'Нету.')
                .addBlankField('>ID Системного канала<', message.channel.guild.systemChannelID !== null ? message.channel.guild.systemChannelID : 'Нету.', inline)
                .addField('>Имя сервера<', message.channel.guild.name)
                .addBlankField('>Сокращеное имя сервера<', message.channel.guild.nameAcronym, inline)
                .addField('>AFK канал<', message.channel.guild.afkChannel !== null ? message.channel.guild.afkChannel : 'Нету.')
                .addBlankField('>ID AFK канала<', message.channel.guild.afkChannelID !== null ? message.channel.guild.afkChannelID : 'Нету.', inline)
