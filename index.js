...
message.delete();
   ...
   let user3 = message.guild.member(message.guild.members.get(args[2]));
    ...
    if (['poll'].includes(command)) {
        ...
        .setDescription(afkMessage.replace(/`/g, "`" + String.fromCharCode(8203)))
